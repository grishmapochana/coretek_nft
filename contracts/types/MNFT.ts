...
export interface MNFTInterface extends utils.Interface {
  functions: {
    ...
    "getLatestToken()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getAllTokensOwnedBy",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getLatestToken",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "TokenMinted(uint256,string,address)": EventFragment;
...
export interface MNFT extends BaseContract {
  ...
  functions: {
    ...
    getLatestToken(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "TokenMinted(uint256,string,address)"(
      tokenId?: PromiseOrValue<BigNumberish> | null,
      tokenURI?: null,
  ...
  populateTransaction: {
    ...
    getLatestToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
